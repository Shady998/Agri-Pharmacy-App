...
export class SettingsController {
  ...
  async getSettings(@CurrentTenant('id') tenantId: string) {
  ...
  async updateSettings(@CurrentTenant('id') tenantId: string, @Body() settings: Record<string, any>) {
  ...
  async getUnits(@CurrentTenant('id') tenantId: string) {
